...
ga2vg.o : ga2vg.cpp sgclient.h download.h side2seq.h ${basicLibsDependencies}
...
ga2vg : ga2vg.o sgclient.o download.o json2sg.o side2seq.o ${basicLibsDependencies}
	${cpp} ${cppflags}  ga2vg.o sgclient.o download.o json2sg.o side2seq.o ${basicLibs} -o ga2vg 
